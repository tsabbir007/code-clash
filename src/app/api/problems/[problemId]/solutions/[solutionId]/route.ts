...
export async function PUT(
    ...
    try {
        ...
        console.log('Updating solution:', solutionId, 'for problem:', problemId, 'by user:', session.user.id);
...
export async function DELETE(
    ...
    try {
        ...
        console.log('Deleting solution:', solutionId, 'for problem:', problemId, 'by user:', session.user.id);
